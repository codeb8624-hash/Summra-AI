...
import com.example.summraai.viewmodel.WebsiteSummaryViewModel
                ...
                item {
                    Column {
                        ...
                        SummraPrimaryButton(
                            ...
                            modifier = Modifier.fillMaxWidth(),
                            enabled = url.isNotBlank() && (url.startsWith("http://") || url.startsWith("https://")) && uiState !is UiState.Loading
                        )
                    }
                }
    ...
    Surface(
        ...
        Row(
            ...
            OutlinedTextField(
                ...
                modifier = Modifier.weight(1f),
                placeholder = { Text("Ask anything about this article...") },
                maxLines = 4,
                enabled = enabled,
        ...
        Card(
            ...
            Column(modifier = Modifier.padding(Spacing.md)) {
                ...
                Row(
                    ...
                    if (result.originalWordCount != null && result.originalWordCount > 0) {
                        val ratio = ((1.0 - (result.wordCount?.toDouble() ?: 0.0) / result.originalWordCount) * 100).toInt()
                        Text(
                    ...
                    if (result.readingTimeSeconds != null) {
                        val min = result.readingTimeSeconds / 60
                        val sec = result.readingTimeSeconds % 60
                        Text(
